...
class TestKiwoomSimulatorBalanceManagement:
    ...
    @pytest.mark.asyncio
    async def test_buy_order_decreases_cash_balance(self):
    ...
    @pytest.mark.asyncio
    async def test_sell_order_increases_cash_balance(self):
        ...
        # 매수 후 잔고 확인
        account_after_buy = await simulator.get_account()
        ...
        # Then: 예수금이 증가함
        account_after_sell = await simulator.get_account()
        assert account_after_sell.cash_balance > balance_after_buy

    @pytest.mark.asyncio
    async def test_total_asset_value_calculation(self):
...
class TestKiwoomSimulatorPositionManagement:
    ...
    @pytest.mark.asyncio
    async def test_buy_order_creates_position(self):
    ...
    @pytest.mark.asyncio
    async def test_additional_buy_increases_position_quantity(self):
        ...
        await simulator.submit_order(order1)
        ...
        await simulator.submit_order(order2)
    ...
    @pytest.mark.asyncio
    async def test_sell_order_decreases_position_quantity(self):
    ...
    @pytest.mark.asyncio
    async def test_insufficient_position_quantity_rejects_sell(self):
    ...
    @pytest.mark.asyncio
    async def test_sell_without_position_rejects_order(self):
...
class TestKiwoomSimulatorErrorScenarios:
    ...
    @pytest.mark.asyncio
    async def test_injected_insufficient_balance_error(self):
    ...
    @pytest.mark.asyncio
    async def test_injected_invalid_stock_code_error(self):
    ...
    @pytest.mark.asyncio
    async def test_injected_api_timeout_error(self):
    ...
    @pytest.mark.asyncio
    async def test_invalid_stock_code_without_injection(self):
    ...
    @pytest.mark.asyncio
    async def test_get_stock_price_for_nonexistent_stock(self):
    ...
    @pytest.mark.asyncio
    async def test_error_injection_can_be_cleared(self):
        ...
        with pytest.raises(TimeoutError):
            await simulator.get_stock_price("005930")
